...
import { PenToolIcon as Tool, Home, Building } from "lucide-react"
      ...
      <main className="flex-grow flex items-center justify-center p-6 bg-gradient-to-b from-blue-50 to-white">
        <div className="absolute inset-0 overflow-hidden z-0">
          ...
          <div
            ...
            style={{ backgroundImage: "url('/placeholder.svg?height=200&width=1200')" }}
          ></div>
        </div>
        ...
        <Card className="w-full max-w-md shadow-xl relative z-10 border-blue-100">
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-6 rounded-t-lg text-white text-center">
            ...
            <h1 className="text-2xl font-bold">BPHC Hostel Maintenance</h1>
            <p className="text-blue-100 mt-1">Sign in to report and track maintenance issues</p>
          </div>
            ...
            <div className="text-center mb-6">
              <div className="bg-blue-50 p-4 rounded-lg mb-6">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Report maintenance issues in your hostel room and track their resolution status
                </p>
              </div>
              ...
              <p className="text-sm text-gray-500 mt-6">Use your BITS email to access the maintenance portal</p>
            </div>

            <div className="border-t border-gray-200 pt-4 text-center">
              <p className="text-sm text-gray-600">For assistance, contact the hostel administration office</p>
            </div>
          </CardContent>
        </Card>
      </main>
